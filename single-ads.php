            ...
            <div class="breadcrumbs text-sm mb-2" itemprop="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
              <ul class="flex items-center flex-wrap">
                ...
                <li itemprop='itemListElement' itemscope itemtype='http://schema.org/ListItem' class="breadcrumbs_item mr-8">
                  <a itemprop="item" href="<?php echo get_post_type_archive_link( 'ads' ); ?>" class="text-blue-700">
          ...
          <div class="w-full lg:w-8/12 lg:px-4">
            ...
            <div class="bg-white shadow rounded-lg p-5 mb-8">
              ...
              <div class="text-gray-600 font-semibold mb-2">
                <?php _e('Контакты', 'g-info'); ?>
              </div>
              <div class="mb-8">
                <ul>
                  <?php 
                  $phones = carbon_get_the_post_meta('crb_ads_phones');
                  foreach($phones as $phone): ?>
                    <li class="italic">
                      <a href="tel:<?php echo $phone['crb_ads_phone']; ?>"><?php echo $phone['crb_ads_phone']; ?></a>
                    </li>
                  <?php endforeach; ?>
                </ul>
              </div>
              ...
              <div class="flex flex-wrap items-center lg:-mx-2">
                <?php 
                  $photos = carbon_get_the_post_meta('crb_ads_photos');
                  foreach ( $photos as $photo ): ?>
                  <div class="w-1/2 lg:w-1/4 h-40 px-2 mb-4">
                    ...
                    <a href="<?php echo $photo_src[0]; ?>" data-lightbox="wow-gallery" data-title="<?php the_title(); ?>">
                      <img src="<?php echo $photo_src[0]; ?>" loading="lazy" class="w-full h-full object-cover"> 
                    </a>
                  </div>
                <?php endforeach; ?>
              </div>
